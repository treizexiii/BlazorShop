...
namespace BlazorShop.Server.Migrations
{
    ...
    [Migration("20210407062634_ProductDateFix")]
            ...
            modelBuilder.Entity("BlazorShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 584, DateTimeKind.Local).AddTicks(3000),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2544),
                        ...
                        new
                        {
                            Id = 18,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2571),
                        ...
                        new
                        {
                            Id = 57,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2576),
                        ...
                        new
                        {
                            Id = 22,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2578),
                        ...
                        new
                        {
                            Id = 76,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2581),
                        ...
                        new
                        {
                            Id = 77,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 4, 7, 8, 26, 34, 586, DateTimeKind.Local).AddTicks(2583),

...
namespace BlazorShop.Server.Migrations
{
    ...
    [Migration("20210406204237_ProductRemoveFromCategroyModel")]
    partial class ProductRemoveFromCategroyModel
    {
            ...
            modelBuilder.Entity("BlazorShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 364, DateTimeKind.Local).AddTicks(3077),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2358),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 18,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2386),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 57,
                            CategoryId = 3,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2390),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 22,
                            CategoryId = 1,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2393),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 76,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2395),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 77,
                            CategoryId = 2,
                            DateCreated = new DateTime(2021, 4, 6, 22, 42, 37, 366, DateTimeKind.Local).AddTicks(2398),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
